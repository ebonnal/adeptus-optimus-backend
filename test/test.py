...
class Test(unittest.TestCase):
    ...
    def test_engine_core(self):
        ...
        w3, w4 = Weapon("5", "7", "2D6", "1", "1", bonuses=Bonuses.empty()), Weapon("5", "2D6", "2D6", "1", "1",
                                                                                    bonuses=Bonuses.empty())
        self.assertTrue(float_eq(score_weapon_on_target(w3, t1), score_weapon_on_target(w4, t1)))  # Bonuses
        t = Target(t=4, sv=5, invu=None, fnp=6, w=6)
        self.assertTrue(
            score_weapon_on_target(Weapon(hit="5", a="D6", s="4", ap="D6", d="D6", bonuses=Bonuses(0, 0)), t) ==
        ...
        self.assertTrue(
            score_weapon_on_target(Weapon(hit="5", a="D6", s="4", ap="D6", d="D6", bonuses=Bonuses(-1, 0)), t) ==
            score_weapon_on_target(Weapon(hit="6", a="D6", s="4", ap="D6", d="D6", bonuses=Bonuses(0, 0)), t))
        self.assertTrue(
            score_weapon_on_target(Weapon(hit="5", a="D6", s="4", ap="D6", d="D6", bonuses=Bonuses(0, -1)), t) ==
            score_weapon_on_target(Weapon(hit="5", a="D6", s="3", ap="D6", d="D6", bonuses=Bonuses(0, 0)), t))
